...
urlpatterns = [
    ...
    url(r'^password_change', django.contrib.auth.views.password_change, {'post_change_redirect': '/', 'template_name':'cmumc/change_password.html'},
        name='password_change'),
    url(r'^password_change_done', django.contrib.auth.views.password_change_done, {'post_change_redirect': '/'}, name='password_change_done'),
